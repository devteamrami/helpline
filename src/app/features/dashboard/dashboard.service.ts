...
export interface DashboardStats {
  ...
  tasks: { total: number; inActiveProjects: number; toDo: number; inProgress: number; inReview: number; done: number; blocked: number; active: number; onHold: number; completed: number };
